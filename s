...
!python finetune_dualstylegan.py --iter 1500 --batch 4 --ckpt /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/generator-pretrain.pt --style_loss 0.25 --CX_loss 0.25 --perc_loss 1 --id_loss 1 --L2_reg_loss 0.015 --encoder_path /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/encoder.pt  --image_path /kaggle/input/zhoudualstylegan/DualStyleGAN/data/head2/images/train --lmdb_path /kaggle/input/zhoudualstylegan/DualStyleGAN/data/head2/lmdb --identity_path /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/model_ir_se50.pth --exstyle_path /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/head2/exstyle_code.npy --instyle_path /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/head2/instyle_code.npy --augment head2