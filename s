...
!python finetune_dualstylegan.py --iter 1500 --batch 4 --ckpt /kaggle/input/zhoudualstylegan/DualStyleGAN/data/simpsons/generator-pretrain.pt --style_loss 0.25 --CX_loss 0.25 --perc_loss 1 --id_loss 1 --L2_reg_loss 0.015 --encoder_path /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/encoder.pt  --image_path /kaggle/input/zhoudualstylegan/DualStyleGAN/data/simpsons/images/train --lmdb_path /kaggle/input/zhoudualstylegan/DualStyleGAN/data/simpsons/lmdb --identity_path /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/model_ir_se50.pth --exstyle_path /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/simpsons/exstyle_code.npy --instyle_path /kaggle/input/zhoudualstylegan/DualStyleGAN/checkpoint/simpsons/instyle_code.npy --augment simpsons
