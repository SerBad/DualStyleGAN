...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--name", type=str, default='cartoon_generate',
                                 help="filename to save the generated images")
        self.parser.add_argument("--fix_content", action="store_true",
                                 help="using a fixed intrinsic style code (content)")
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        img_gen, _ = generator([instyle], exstyle, input_is_latent=False, truncation=args.truncation,
                               truncation_latent=0,
