...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--wandb", action="store_true", default=False, help="use weights and biases logging")
...
def train(args, loader, generator, discriminator, g_optim, d_optim, g_ema, instyles, Simgs, exstyles, vggloss, id_loss,
          device):
...
if __name__ == "__main__":
    ...
    train(args, loader, generator, discriminator, g_optim, d_optim, g_ema, instyles, Simgs, exstyles, vggloss, id_loss,
          device)
